...
$_SETTINGS = [
	"to"						=> "contact@inkedbykorpse.com",							// To Address
	"toAlt"						=> "InkedbyKorpse:contact@inkedbykorpse.com",						// Additional Recipients
	"from"						=> "contact@inkedbykorpse.com",						// From Address
	"fromName"					=> "InkedbyKorpse",					// From Name
	...
	"attachmentsExtensions"		=> "bmp,gif,ico,jpeg,jpg,pdf,png,svg,webp",		// File Extensions
